...
export default class Swiper {
  ...
  constructor(element) {
    ...
    this.slides = [...this.element.querySelectorAll(":scope > .swiper-slide")]
      .length
  ...
  swiping() {
    ...
    window.addEventListener(this.isMobile ? "touchmove" : "mousemove", (e) => {
      ...
      this.pos.current = this.isMobile
        ? e.touches[0].clientX + this.pos.stored
        : e.clientX + this.pos.stored;
  ...
  update() {
    ...
    gsap.ticker.add(() => {
      ...
      this.slides.forEach((slide, index) => {
        ...
        if (this.options.parallax) {
          slide.positionX =
            this.pos.lerp + this.centeringOffset + slide.loop * this.totalWidth;
          slide.scale =
